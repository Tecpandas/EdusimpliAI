...
class PDFKnowledgeBaseBuilder:
    ...
    def __init__(self, subject_name, pdf_folder_path):
        ...
        # Use a more powerful model specifically designed for semantic search and retrieval
        self.kb.embedding_model = SentenceTransformer('msmarco-distilbert-base-v4')
    ...
    def build(self):
        ...
        chunk_embeddings_np = self.kb.embedding_model.encode(self.kb.chunks, show_progress_bar=True)
